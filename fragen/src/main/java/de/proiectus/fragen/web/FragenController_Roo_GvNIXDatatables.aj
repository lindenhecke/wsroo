...
import de.proiectus.fragen.web.FragenController_Roo_Controller;
import de.proiectus.fragen.web.FragenController_Roo_GvNIXDatatables;
...
privileged aspect FragenController_Roo_GvNIXDatatables {
    
    declare precedence: FragenController_Roo_GvNIXDatatables, FragenController_Roo_Controller;
    
    @Autowired
    public ConversionService FragenController.conversionService_dtt;
    
    @Autowired
    public MessageSource FragenController.messageSource_dtt;
    
    public BeanWrapper FragenController.beanWrapper;
    
    @RequestMapping(method = RequestMethod.GET, produces = "text/html")
    public String FragenController.listDatatables(Model uiModel, HttpServletRequest request) {
    ...
    @ModelAttribute
    public void FragenController.populateDatatablesConfig(Model uiModel) {
    ...
    public String FragenController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        // overrides the standard Roo list method and
        // delegates on datatables list method
        return listDatatables(uiModel, null);
    }
    
    public Map<String, String> FragenController.populateParametersMap(HttpServletRequest request) {
    ...
    public Map<String, Object> FragenController.getPropertyMap(Fragen fragen, Enumeration<Map<String, String>> propertyNames) {
        Map<String, Object> propertyValuesMap = new HashMap<String, Object>();
        
        // If no entity or properties given, return empty Map
        if(fragen == null || propertyNames == null) {
        ...
        BeanWrapper entityBean = new BeanWrapperImpl(fragen);
    ...
    public Map<String, Object> FragenController.getPropertyMap(Fragen fragen, HttpServletRequest request) {
        // URL parameters are used as base search filters
        @SuppressWarnings("unchecked") Map<String, Object> propertyValuesMap = getPropertyMap(fragen, request.getParameterNames());
    ...
    public void FragenController.setDatatablesBaseFilter(Map<String, Object> propertyMap) {
        // Add here your baseFilters to propertyMap.
    }
    
    @ResponseBody
    @RequestMapping(headers = "Accept=application/json", params = "getColumnType")
    public String FragenController.getColumnType(Model uiModel, HttpServletRequest request, @RequestParam(value = "_columnName_", required = false) String columnName) {
        // Getting all declared fields
        boolean fieldExists = false;
        Field attr = null;
        for(Field field : Fragen.class.getDeclaredFields()){
        ...
        if(!fieldExists){
            if(Fragen.class.getSuperclass() != null){
                for(Field field : Fragen.class.getSuperclass().getDeclaredFields()){
                    if(field.getName().equals(columnName)){
                        attr = field;
                        fieldExists = true;
                        break;
    ...
    public String FragenController.geti18nText(Model uiModel, HttpServletRequest request, @RequestParam(value = "_locale_", required = false) String locale) {
    ...
    public String FragenController.listDatatablesDetail(Model uiModel, HttpServletRequest request, @ModelAttribute Fragen fragen) {
        ...
        return "forward:/WEB-INF/views/fragens/list.jspx";
    }
    
    @RequestMapping(produces = "text/html", method = RequestMethod.POST, params = "datatablesRedirect")
    public String FragenController.createDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid Fragen fragen, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common create operations (check errors, populate, persist, ...)
        String view = create(fragen, bindingResult, uiModel, httpServletRequest);
        ...
        redirectModel.addFlashAttribute(DatatablesUtils.ROWS_ON_TOP_IDS_PARAM, fragen.getId());
    ...
    public String FragenController.updateDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @Valid Fragen fragen, BindingResult bindingResult, Model uiModel, RedirectAttributes redirectModel, HttpServletRequest httpServletRequest) {
        // Do common update operations (check errors, populate, merge, ...)
        String view = update(fragen, bindingResult, uiModel, httpServletRequest);
    ...
    public String FragenController.deleteDatatablesDetail(@RequestParam(value = "datatablesRedirect", required = true) String redirect, @PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    @ResponseBody
    public DatatablesResponse<Map<String, String>> FragenController.findAllFragens(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute Fragen fragen, HttpServletRequest request) {
        // URL parameters are used as base search filters
        Map<String, Object> baseSearchValuesMap = getPropertyMap(fragen, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        SearchResults<Fragen> searchResult = DatatablesUtils.findByCriteria(Fragen.class, Fragen.entityManager(), criterias, baseSearchValuesMap, conversionService_dtt, messageSource_dtt);
    ...
    @ResponseBody
    public ResponseEntity<String> FragenController.checkFilterExpressions(WebRequest request, @RequestParam(value = "property", required = false) String property, @RequestParam(value = "expression", required = false) String expression) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        if(beanWrapper == null){
            beanWrapper = new BeanWrapperImpl(Fragen.class);
        }
    ...
    @RequestMapping(headers = "Accept=application/json", value = "/datatables/ajax", params = "ajax_find=ByKattype", produces = "application/json")
    @ResponseBody
    public DatatablesResponse<Map<String, String>> FragenController.findFragensByKattype(@DatatablesParams DatatablesCriterias criterias, @RequestParam("kattype") FragenKategorie kattype) {
        ...
        baseSearch.and(entity.get("kattype").eq(kattype));
        
        SearchResults<Fragen> searchResult = DatatablesUtils.findByCriteria(entity, Fragen.entityManager(), criterias, baseSearch);
    ...
    @RequestMapping(headers = "Accept=application/json", value = "/datatables/ajax", params = "ajax_find=ByKat", produces = "application/json")
    @ResponseBody
    public DatatablesResponse<Map<String, String>> FragenController.findFragensByKat(@DatatablesParams DatatablesCriterias criterias, @RequestParam("kat") Kategorie kat) {
        BooleanBuilder baseSearch = new BooleanBuilder();
        ...
        baseSearch.and(entity.get("kat").eq(kat));
    ...
    public void FragenController.exportCsv(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute Fragen fragen, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, fragen, ExportType.CSV, new CsvExport(), request, response);
    }
    
    @RequestMapping(value = "/exportpdf", produces = "text/pdf")
    public void FragenController.exportPdf(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute Fragen fragen, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, fragen, ExportType.PDF, new PdfExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxls", produces = "text/xls")
    public void FragenController.exportXls(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute Fragen fragen, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, fragen, ExportType.XLS, new XlsExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxlsx", produces = "text/xlsx")
    public void FragenController.exportXlsx(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute Fragen fragen, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, fragen, ExportType.XLSX, new XlsxExport(), request, response);
    }
    
    @RequestMapping(value = "/exportxml", produces = "text/xml")
    public void FragenController.exportXml(@DatatablesParams DatatablesCriterias criterias, @ModelAttribute Fragen fragen, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ExportException {
        export(criterias, fragen, ExportType.XML, new XmlExport(), request, response);
    }
    
    private void FragenController.export(DatatablesCriterias criterias, Fragen fragen, ExportType exportType, DatatablesExport datatablesExport, HttpServletRequest request, HttpServletResponse response) throws ExportException {
        ...
        // 1. Retrieve the data
        List<Map<String, String>> data = retrieveData(criterias, fragen, request);
        // 2. Build an instance of "ExportConf"
        ExportConf exportConf = new ExportConf.Builder(exportType).header(true).exportClass(datatablesExport).autoSize(true).fileName(fragen.getClass().getSimpleName()).build();
    ...
    private List<Map<String, String>> FragenController.retrieveData(DatatablesCriterias criterias, Fragen fragen, HttpServletRequest request) {
        ...
        Map<String, Object> baseSearchValuesMap = getPropertyMap(fragen, request);
        setDatatablesBaseFilter(baseSearchValuesMap);
        org.gvnix.web.datatables.query.SearchResults<de.proiectus.fragen.data.Fragen> searchResult = DatatablesUtils.findByCriteria(Fragen.class, Fragen.entityManager(), noPaginationCriteria, baseSearchValuesMap);
    ...
    @ResponseBody
    public List<Map<String, String>> FragenController.createJsonForm(HttpServletRequest request, HttpServletResponse response, Model uiModel) throws ServletException, IOException {
        
        // Prepare result
        List<Map<String, String>> result = new ArrayList<Map<String, String>>();
        String controllerPath = "fragens";
        ...
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(fragen, "fragen");
        bindingResult.initConversion(conversionService_dtt);
        request.setAttribute(BindingResult.MODEL_KEY_PREFIX + "fragen", bindingResult);
        
        populateItemForRender(request, fragen, true);
    ...
    @ResponseBody
    public List<Map<String, String>> FragenController.updateJsonForms(@RequestParam("id") Long[] ids, HttpServletRequest request, HttpServletResponse response, Model uiModel) throws ServletException, IOException {
        if (ArrayUtils.isEmpty(ids)) {
            return new ArrayList<Map<String, String>>();
        }
        
        // Using PathBuilder, a cascading builder for Predicate expressions
        PathBuilder entity = new PathBuilder(Fragen.class, "entity");
        // URL parameters are used as base search filters
        Set set = new HashSet();
        ...
        // execute query
        List<Fragen> fragens = query.where(filterBy).list(entity);
        List<Map<String, String>> udpateForms = renderUpdateForm(fragens, request, response);
        return udpateForms;
    }
    
    public List<Map<String, String>> FragenController.renderUpdateForm(List<Fragen> fragens, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Prepare result
        List<Map<String, String>> result = new ArrayList<Map<String, String>>(fragens.size());
        String controllerPath = "fragens";
        ...
        for (Fragen fragen : fragens) {
            ...
            String render = buffer.toString();
            // Load item id
            item.put("DT_RowId", conversionService_dtt.convert(fragen.getId(), String.class));
            // Put rendered content into first column
            item.put("form", render);
            result.add(item);
        }
    ...
    public void FragenController.populateItemForRender(HttpServletRequest request, Fragen fragen, boolean editing) {
        org.springframework.ui.Model uiModel = new org.springframework.ui.ExtendedModelMap();
        
        request.setAttribute("fragen", fragen);
        request.setAttribute("itemId", conversionService_dtt.convert(fragen.getId(),String.class));
        ...
        if (editing) {
            ...
            BeanPropertyBindingResult bindindResult = new BeanPropertyBindingResult(fragen, "fragen");
            bindindResult.initConversion(conversionService_dtt);
            request.setAttribute(BindingResult.MODEL_KEY_PREFIX + "fragen",bindindResult);
            // Add date time patterns and enums to populate inputs
            populateEditForm(uiModel, fragen);
        }
